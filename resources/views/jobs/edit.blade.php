<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="title" name='title' label='Title' placeholder='Software Engineer'
            ...
            <x-inputs.text-area id="requirements" name='requirements' label='Requirements'
                ...
                degree in Computer Science" :value="old('requirements', $job->requirements)" />
            ...
            <x-inputs.text id="tags" name='tags' label='Tags (coma-separated)'
